  ...
  return (
    <div className='self-center w-full'>
      <div className='h-[92vh] w-full flex flex-1 items-center justify-start lg:justify-center  relative overflow-x-hidden overflow-clip'>
        ...
        <Image src={Astronaut} alt="Astronaut" className='absolute -bottom-10 right-0 animate-bump-out-in-right  select-none' />
        <Image src={Moon} alt="Moon" className='animate-bump-out-in-left absolute top-0 lg:top-[8rem] -left-20 lg:-left-80 h-[10rem] w-[10rem] lg:h-[40rem] lg:w-[40rem]  select-none' />
